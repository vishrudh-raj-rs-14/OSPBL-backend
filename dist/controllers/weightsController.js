...
exports.processImages =
  exports.uploadPhotos =
  exports.deleteAllWeights =
  exports.deleteWeights =
  exports.createWeights =
  exports.getAllCompleteWeights =
...
const processImages = (0, express_async_handler_1.default)((req, res, next) =>
...
const createWeights = (0, express_async_handler_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getAllWeights = (0, express_async_handler_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const startOfDay = new Date();
    startOfDay.setHours(0, 0, 0, 0);
    const weights = yield weightsModel_1.default
      .find({
        measuredAt: {
          $gte: startOfDay,
        },
...
const getAllCompleteWeights = (0, express_async_handler_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const weights = yield weightsModel_1.default
      .find()
      .populate('party', 'partyName')
...
const deleteWeights = (0, express_async_handler_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (!req.params.id) {
      res.status(400).json({
        status: 'fail',
    ...
    const weightsRecord = yield weightsModel_1.default.findByIdAndDelete(
      req.params.id
    );
    res.status(200).json({
      status: 'success',
...
const deleteAllWeights = (0, express_async_handler_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
