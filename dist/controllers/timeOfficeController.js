...
exports.gettimeOfficeRecordsOfDay =
  exports.deletetimeOffice =
  exports.updatetimeOffice =
  exports.createtimeOffice =
  exports.gettimeOfficebyId =
  exports.getAlltimeOffices =
    void 0;
...
const getAlltimeOffices = (0, express_async_handler_1.default)((req, res) =>
...
const gettimeOfficeRecordsOfDay = (0, express_async_handler_1.default)(
  (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const limit = parseInt(req.query.limit) || 30;
...
const gettimeOfficebyId = (0, express_async_handler_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (!req.params.id) {
      res.status(400).json({
        status: 'fail',
...
const createtimeOffice = (0, express_async_handler_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const updatetimeOffice = (0, express_async_handler_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { party, vehicleNumber, category, description } = req.body;
    if (!req.params.id) {
      res.status(400).json({
    ...
    const timeOfficeRecord = yield timeOfficeModal_1.default.findById(
      req.params.id
    );
    if (!timeOfficeRecord) {
      res.status(404).json({
...
const deletetimeOffice = (0, express_async_handler_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (!req.params.id) {
      res.status(400).json({
        status: 'fail',
    ...
    const timeOfficeRecord = yield timeOfficeModal_1.default.findByIdAndDelete(
      req.params.id
    );
    res.status(200).json({
      status: 'success',
