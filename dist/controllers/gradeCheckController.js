...
exports.processPDF =
  exports.uploadPDF =
  exports.addGradeCheckData =
  exports.getGradeCheckData =
    void 0;
...
//     })
// })
const processPDF = (0, express_async_handler_1.default)((req, res, next) =>
...
const addGradeCheckData = (0, express_async_handler_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const party =
      toRecord === null || toRecord === void 0 ? void 0 : toRecord.party;
    const Items = weights;
    const vehicleNumber =
      toRecord === null || toRecord === void 0
        ? void 0
        : toRecord.vehicleNumber;
    const date = new Date();
    ...
    const itemListTemp = Items.map((item) =>
      __awaiter(void 0, void 0, void 0, function* () {
        var _a;
        return (_a = yield productModel_1.default.findById(item.materialId)) ===
          null || _a === void 0
          ? void 0
          : _a.code;
      })
    ...
    const itemsWithPricePromise = Items.map((item) =>
      __awaiter(void 0, void 0, void 0, function* () {
        ...
        const unitPrice =
          (_c =
            (_b = yield productModel_1.default.findById(item.materialId)) ===
              null || _b === void 0
              ? void 0
              : _b.price) === null || _c === void 0
            ? void 0
            : _c.find((price) => String(price.party) == String(party));
