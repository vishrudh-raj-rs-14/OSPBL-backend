...
const getAllVouchers = (0, express_async_handler_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    let vouchers = voucherModel_1.default
      .find(filter)
      .sort({ date: -1 })
      .populate('party');
    if (limit != -1) {
...
const getFile = (0, express_async_handler_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getVoucher = (0, express_async_handler_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    if (!id) {
      res.status(400).json({
    ...
    const voucher = yield voucherModel_1.default
      .findById(id)
      .populate('party')
      .populate({
...
const getVouchersofDay = (0, express_async_handler_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const limit = parseInt(req.query.limit) || 30;
    ...
    let voucher = yield voucherModel_1.default
      .find({
        date: {
          $gte: startOfDay,
          $lt: endOfDay,
...
const createVoucher = (0, express_async_handler_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const itemsWithPricePromise = Items.map((item) =>
      __awaiter(void 0, void 0, void 0, function* () {
        var _a, _b;
        const unitPrice =
          (_b =
            (_a = yield productModel_1.default.findById(item.item.id)) ===
              null || _a === void 0
              ? void 0
              : _a.price) === null || _b === void 0
            ? void 0
            : _b.find((price) => price.party == party);
    ...
    const modifiedItems = Items.map((item) => {
      const { unitPrice, netPrice } = item,
        rest = __rest(item, ['unitPrice', 'netPrice']);
      return rest;
    });
...
const deleteVoucher = (0, express_async_handler_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    if (!id) {
      res.status(400).json({
...
const vehicleLeft = (0, express_async_handler_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    if (!id) {
      res.status(400).json({
    ...
    const tempOfficeRecord = yield timeOfficeModal_1.default.findByIdAndUpdate(
