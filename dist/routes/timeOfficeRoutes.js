...
timeOfficeRouter.get('/', userController_1.protect, (0, userController_1.restricTo)("ADMIN", "SECURITY", "GRADE-CHECKER"), timeOfficeController_1.gettimeOfficeRecordsOfDay);
...
timeOfficeRouter.get('/today', userController_1.protect, (0, userController_1.restricTo)('ADMIN', 'SECURITY', "GRADE-CHECKER"), timeOfficeController_1.gettimeOfficeRecordsOfDay);
