...
voucherRouter.get("/", userController_1.protect, (0, userController_1.restricTo)("ADMIN", "GRADE_CHECKER", "SECURITY"), voucherController_1.getVouchersofDay);
...
voucherRouter.post("/", userController_1.protect, (0, userController_1.restricTo)("ADMIN", "GRADE_CHECKER"), voucherController_1.createVoucher);
