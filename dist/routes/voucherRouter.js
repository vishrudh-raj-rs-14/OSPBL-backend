...
voucherRouter.get('/get-pdf/:filename', userController_1.protect, (0, userController_1.restricTo)("ADMIN", "GRADE-CHECKER"), voucherController_1.getFile);
voucherRouter.get("/all", userController_1.protect, (0, userController_1.restricTo)("ADMIN", "GRADE-CHECKER"), voucherController_1.getAllVouchers);
voucherRouter.get("/:id", userController_1.protect, (0, userController_1.restricTo)("ADMIN", "GRADE-CHECKER"), voucherController_1.getVoucher);
