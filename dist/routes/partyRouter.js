...
partyRouter.get("/", partyController_1.getAllParties);
partyRouter.get("/:id", partyController_1.getPartybyId);
partyRouter.post("/", userController_1.protect, (0, userController_1.restricTo)("ADMIN"), partyController_1.createParty);
